...
const Mer: React.FC = () => {
  ...
  const images = [
    "bulfran/mer-barre.jpg",
    "bulfran/mer-bateau.jpg",
    "bulfran/mer-portecle.jpg"
  ];
  ...
  return (
    <div className="w-[80%] mx-auto py-12">
      <nav className="text-sm mb-8 text-gray-500 font-bold uppercase">
        ...
        <span className="mx-2">/</span>
        <span className="text-gray-900">Mer</span>
      </nav>

      <h1 className="text-3xl font-bold text-center mb-12 uppercase">Mer</h1>
